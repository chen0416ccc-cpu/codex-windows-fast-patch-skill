...
Supported service profiles are `26.924.22138`, `26.924.20706`, `26.917.71314`, `26.908.40834`, and `26.908.70816`, selected by complete SHA-256 rather than version prefix. Profile `26.917.71314` passed real Windows navigation, input, click, and server-observed `x-browser-agent` acceptance without an additional login. Profile `26.924.22138` passes local behavior, guard, cache-scope, and trusted-client contract checks, which are not live browser acceptance; the offline evidence for `26.924.20706` comes from reviewed PR #73. The two `26.908` profiles have offline guard/behavior regression coverage only; the older Desktop was not reinstalled for live acceptance.
