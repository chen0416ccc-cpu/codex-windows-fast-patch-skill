...
- `scripts/patch-computer-use-helper-win10.ps1`：为精确支持哈希的 `@oai/sky 0.4.20`、`0.5.2`、`0.6.6`、`0.6.11` 和 `0.6.16` helper 提供只读识别、安装和回滚；`26.707.12708.0`、`26.721.4979.0`、`26.803.10989.0`、`26.810.6296.0`、`26.810.7004.0`、`26.814.5167.0` 与 `26.814.5517.0` 是各自的端到端验证基线，不是版本门槛。同一个 `0.6.16` 系列在两个 Desktop 版本上是不同的 helper 二进制，profile 按完整哈希选取。最新 `26.814.5517.0` 基线包含八帧全唯一静态截图、二十帧全唯一动态截图和预热后资源稳定性验证。
